...
public class CategoriaAdapter extends ArrayAdapter<Categoria> {
    ...
    public CategoriaAdapter(@NonNull Context context, int resource, int textViewResourceId, @NonNull List<Categoria> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext().getApplicationContext()).inflate(R.layout.varios_item, parent, false);
